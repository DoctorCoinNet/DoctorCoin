...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Nov 9 07:02:06 2017
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/DoctorCoin/src/leveldb/libleveldb.a /tmp/DoctorCoin/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /tmp/DoctorCoin/src/leveldb/libleveldb.a; cd /tmp/DoctorCoin/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/tmp/DoctorCoin/src/leveldb/libleveldb.a: FORCE
	cd /tmp/DoctorCoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/tmp/DoctorCoin/build/build.h: FORCE
	cd /tmp/DoctorCoin; /bin/sh share/genbuild.sh /tmp/DoctorCoin/build/build.h
